...
export const QUESTIONS: Question[] = [
  ...
  { id: 95, text: "In a 50-over match, a batsman hits 10 sixes and 15 fours and scores 140 runs. How many singles did he run?", choices: ["20", "30", "25", "35"], correctIndex: 0, runs: 2, stage: "finals" },
  { id: 96, text: "A team scores 200 runs in 40 overs. They need 300 to win in 50 overs. What should be their required run rate?", choices: ["10", "5.5", "6.5", "7"], correctIndex: 0, runs: 2, stage: "finals" },
  ...
  { id: 105, text: "In an IPL match, a team scores runs per over as Poisson with mean λ = 10. Find the probability that they score 150 or fewer runs in 20 overs.", choices: ["0.0002", "0.002", "0.02", "0.2"], correctIndex: 0, runs: 6, stage: "finals" },
  ...
  { id: 110, text: "A bowler has bowled 30 balls with probability 0.1 of taking a wicket per ball. What is the probability he takes at least 1 wicket?", choices: ["0.95", "0.96", "0.97", "0.98"], correctIndex: 1, runs: 2, stage: "finals" },
  { id: 111, text: "In a 20-over match, a batsman hits 5 sixes and 12 fours and scores 85 runs. How many singles did he make?", choices: ["10", "7", "15", "18"], correctIndex: 1, runs: 2, stage: "finals" },
  ...
  { id: 115, text: "A bowler concedes 5, 3, 2, 4, 6, 0 runs in 6 balls. Find the mean and variance of runs per ball.", choices: ["3.33, 3.22", "3.33, 3.56", "3.33, 3.89", "3.33, 2.56"], correctIndex: 2, runs: 4, stage: "finals" },
  { id: 116, text: "A circular cricket ground has radius 60 m. If the boundary rope is moved 10 m inward, find the percentage reduction in area.", choices: ["28.3%", "30.6%", "26.6%", "27.3%"], correctIndex: 1, runs: 4, stage: "finals" },
