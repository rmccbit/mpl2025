...
export const QUESTIONS: Question[] = [
  ...
  { id: 5, text: "A batsman scored 120 runs in 4 innings. His scores were 30, 20, 25, and 45. What will be his average after one more inning scoring 50 runs?", choices: ["35", "40", "38", "37.5"], correctIndex: 2, runs: 2, stage: "group" },
  ...
  { id: 10, text: "In a T20 match, a batsman scored 45, 55, 30, 50, and 60 runs in 5 matches. What is his median score?", choices: ["50", "45", "55", "60"], correctIndex: 2, runs: 4, stage: "group" },
  { id: 11, text: "A team scores 210 runs in 40 overs. If the first 20 overs are played at 4.5 runs per over, what is the required run rate for the remaining 20 overs to reach 210?", choices: ["5", "5.25", "5.5", "5.75"], correctIndex: 2, runs: 4, stage: "group" },
  ...
  { id: 21, text: "A batsman scores 15, 20, 25, 30 runs in four innings. How many runs must he score in the fifth inning to average 25?", choices: ["25", "30", "35", "40"], correctIndex: 1, runs: 2, stage: "group" },
  ...
  { id: 25, text: "A team scores 240 runs in 40 overs. If the first 20 overs they score at 5 runs per over, what should be their required run rate for remaining 20 overs to reach 240?", choices: ["6", "5.5", "6.5", "7"], correctIndex: 0, runs: 4, stage: "group" },
  { id: 26, text: "A batsman hits 4, 6, 2, 3, 5, 7 runs in 6 balls. What is the mean and range of runs per ball?", choices: ["4.5, 5", "4.5, 6", "4.5, 4", "4, 5"], correctIndex: 1, runs: 4, stage: "group" },
  ...
  { id: 30, text: "A batsman scores 120, 150, 90, 100 in four matches. If he wants an average of 120 over 5 matches, how many runs should he score in the fifth match?", choices: ["100", "110", "120", "130"], correctIndex: 2, runs: 6, stage: "group" },
