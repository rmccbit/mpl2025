...
export const QUESTIONS: Question[] = [
  ...
  { id: 65, text: "A batsman scores 35, 42, 58, and 65 runs in his first four innings. If he faced 20, 18, 25, and 22 balls respectively, how many runs should he score in the 5th innings (15 balls) to maintain an overall strike rate of 240?", choices: ["40", "42", "44", "46"], correctIndex: 0, runs: 2, stage: "semifinals" },
  { id: 66, text: "Two batsmen, A and B, share a partnership of 180 runs. If A scores 50% more than B, find their individual scores.", choices: ["A: 100, B: 80", "A: 108, B: 72", "A: 110, B: 70", "A: 120, B: 60"], correctIndex: 1, runs: 2, stage: "semifinals" },
  ...
  { id: 71, text: "In a T20 match, Player X bowls 4 overs at an economy of 6.5, and Player Y bowls 5 overs at an economy of 7.2. Who concedes more runs and by how much?", choices: ["Player X, 10 run more", "Player Y, 10 run more", "Player Y, 5 runs more", "Player X, 5 runs more"], correctIndex: 1, runs: 4, stage: "semifinals" },
  ...
  { id: 79, text: "In a T20 match, Team X’s average run rate for the first 10 overs was 7.5. To finish with an overall average run rate of 9 runs per over, what should be their average run rate in the remaining 10 overs?", choices: ["10.5", "10.8", "11.0", "11.5"], correctIndex: 0, runs: 2, stage: "semifinals" },
  { id: 80, text: "A batsman faces 60 balls and scores 72 runs at a strike rate of 120. He then faces 30 more balls and wants to raise his strike rate to 150. How many runs should he score in the next 30 balls?", choices: ["63", "66", "68", "70"], correctIndex: 1, runs: 0, stage: "semifinals" },
  ...
  { id: 85, text: "A batsman hits 4, 8, 15, 16, and 23 runs in the first 5 balls of an over. What is his average run per ball in this over?", choices: ["11.2", "12.0", "13.2", "14.0"], correctIndex: 2, runs: 4, stage: "semifinals" },
  { id: 86, text: "A cricket team has scores modeled by the function f(x) = 5x² + 2x + 10, where x = overs bowled. What is the total score at the end of 6 overs?", choices: ["250", "202", "274", "286"], correctIndex: 1, runs: 4, stage: "semifinals" },
  ...
  { id: 94, text: "If a batsman scores 36 runs off 30 balls, what is his strike rate?", choices: ["110", "115", "120", "125"], correctIndex: 2, runs: 1, stage: "finals" },
  { id: 95, text: "A bowler takes 4 wickets in 8 overs. What is his strike rate (balls per wicket)?", choices: ["10", "11", "12", "13"], correctIndex: 2, runs: 2, stage: "finals" },
  { id: 96, text: "In a match, Team A scores 180 and Team B scores 175. What is the winning margin?", choices: ["3 runs", "4 runs", "5 runs", "6 runs"], correctIndex: 2, runs: 2, stage: "finals" },
  { id: 97, text: "If the run rate was 4.5 for the first 20 overs, what must it be for the next 30 overs to reach a target of 325 runs?", choices: ["7", "7.5", "7.83", "8"], correctIndex: 2, runs: 2, stage: "finals" },
  { id: 98, text: "In a 50-over match, a batsman hits 10 sixes and 15 fours and scores 140 runs. How many singles did he run?", choices: ["20", "30", "25", "35"], correctIndex: 0, runs: 2, stage: "finals" },
  { id: 99, text: "A team scores 200 runs in 40 overs. They need 300 to win in 50 overs. What should be their required run rate?", choices: ["10", "5.5", "6.5", "7"], correctIndex: 0, runs: 2, stage: "finals" },
  { id: 100, text: "In a cricket match, a team scores runs in 5 consecutive overs as follows: 6, 12, 18, 24, 30 runs. What type of growth does the team’s total runs show over these overs?", choices: ["Arithmetic progression with a common difference of 6", "Geometric progression with a common ratio of 2", "Quadratic growth with increasing differences", "Exponential growth with base 3"], correctIndex: 0, runs: 4, stage: "finals" },
  { id: 101, text: "Virat Kohli scored 50 runs off 30 balls and then scored 20 more runs in the next 10 balls.What is his new strike rate?", choices: ["160", "150", "175", "170"], correctIndex: 2, runs: 4, stage: "finals" },
  { id: 102, text: "A team  scored 180 runs in 20 overs. Their run rate increased by 1.5 runs per over in the last 5 overs compared to the first 15 overs.What was their run rate in the first 15 overs?", choices: ["7", "7.5", "8", "8.625"], correctIndex: 3, runs: 4, stage: "finals" },
  { id: 103, text: "Team B needs 36 runs off 12 balls with 2 wickets left. If every delivery has a 0.20 probability of getting out, what’s the probability they finish with at least 1 wicket?", choices: ["12%", "25%", "27.5%", "20%"], correctIndex: 2, runs: 4, stage: "finals" },
  { id: 104, text: "In a 100-run partnership, A scores runs in the ratio 3 : 2 to B. If A’s strike rate is 25% higher than B’s, then what is the ratio of balls faced by A and B?", choices: ["4 : 3", "3 : 4", "5 : 4", "6 : 5"], correctIndex: 3, runs: 4, stage: "finals" },
  { id: 105, text: "A team scores runs in 6 consecutive overs as 10, 14, 18, 22, 26, 30. What type of growth does this sequence show?", choices: ["Arithmetic progression", "Geometric progression", "Quadratic growth", "Exponential growth"], correctIndex: 0, runs: 4, stage: "finals" },
  { id: 106, text: "A batsman hits 20 boundaries and 10 sixes in 100 runs. If he faced 80 balls, find his strike rate.", choices: ["120", "125", "130", "135"], correctIndex: 1, runs: 4, stage: "finals" },
  { id: 107, text: "In a 3-match series, Team A gets 2 points for a win, 1 for a draw, 0 for a loss. If probability of win is 1/3 and draw is 1/6, what is the probability that Team A scores exactly 5 points?", choices: ["1/16", "1/10", "1/8", "1/18"], correctIndex: 3, runs: 6, stage: "finals" },
  { id: 108, text: "Allowed runs per ball: {0,1,2,3,4,6}. Three balls (ordered). How many ordered triples sum to 12?", choices: ["10", "13", "11", "15"], correctIndex: 1, runs: 6, stage: "finals" },
  { id: 109, text: "In an IPL match, a team’s runs per over follow a Poisson distribution with mean λ=8 runs per over. Find the probability that the team scores at least 180 runs in 20 overs.", choices: ["0.06", "0.22", "0.38", "0.50"], correctIndex: 0, runs: 6, stage: "finals" },
  { id: 110, text: "In an IPL match, a team scores runs per over as Poisson with mean λ = 10. Find the probability that they score 150 or fewer runs in 20 overs.", choices: ["0.0002", "0.002", "0.02", "0.2"], correctIndex: 0, runs: 6, stage: "finals" },
  
  { id: 111, text: "A batsman’s strike rate is 140. If he faces 75 balls, how many runs does he score?", choices: ["110", "120", "105", "100"], correctIndex: 2, runs: 1, stage: "finals" },
  { id: 112, text: "A cricketer has a mean score of 60 runs over 10 innings. How many runs must be scored in the 11th innings to raise the mean to 62?", choices: ["82", "682", "12", "50"], correctIndex: 0, runs: 1, stage: "finals" },
  { id: 113, text: "A team needs 48 runs from 24 balls. What is the required run rate?", choices: ["10", "11", "12", "13"], correctIndex: 2, runs: 1, stage: "finals" },
  { id: 114, text: "A batsman's scores in 4 innings are 45, 55, 65, 75. What is his average?", choices: ["55", "58", "60", "62"], correctIndex: 2, runs: 2, stage: "finals" },
  { id: 115, text: "If a team scores at 9 runs per over for 15 overs, how many runs have they scored?", choices: ["125", "130", "135", "140"], correctIndex: 2, runs: 2, stage: "finals" },
  { id: 116, text: "A bowler faces 50 balls, with a 0.12 probability of taking a wicket per ball. What is the expected number of wickets?", choices: ["6", "4", "8", "10"], correctIndex: 0, runs: 2, stage: "finals" },
  { id: 117, text: "In a cricket innings, a batsman scored 94 runs with 10 boundaries (fours) and some sixes. If he scored 30 singles, how many sixes did he hit?", choices: ["2", "3", "4", "5"], correctIndex: 2, runs: 2, stage: "finals" },
  { id: 118, text: "A bowler has bowled 30 balls with probability 0.1 of taking a wicket per ball. What is the probability he takes at least 1 wicket?", choices: ["0.95", "0.96", "0.97", "0.98"], correctIndex: 1, runs: 2, stage: "finals" },
  { id: 119, text: "In a 20-over match, a batsman hits 5 sixes and 12 fours and scores 85 runs. How many singles did he make?", choices: ["10", "7", "15", "18"], correctIndex: 1, runs: 2, stage: "finals" },
  { id: 120, text: "A bowler concedes runs on each ball independently with distribution: 0 runs (0.4), 1 run (0.3), 2 runs (0.2), 4 runs (0.1). Find the probability that in an over (6 balls) he gives exactly 6 runs.", choices: ["0.07", "0.06", "0.09", "0.10"], correctIndex: 1, runs: 4, stage: "finals" },
  { id: 121, text: "A circular cricket ground has radius R = 50m. The boundary rope is moved 5 m inside for safety. Find the percentage reduction in playing area.", choices: ["13%", "7%", "15%", "19%"], correctIndex: 3, runs: 4, stage: "finals" },
  { id: 122, text: "Team A scores 300 in 50 overs. Due to rain, Team B gets 35 overs. If scoring rate needs to be the same, what should be Team B’s target?", choices: ["200", "210", "210.5", "220"], correctIndex: 1, runs: 4, stage: "finals" },
  { id: 123, text: "A cricket bat has a blade length of 85 cm and a handle length of 35 cm. If another bat has a total length of 144 cm and follows the same proportion between handle and blade, what will be the handle length of the second bat?", choices: ["40", "42", "44", "45"], correctIndex: 1, runs: 4, stage: "finals" },
  { id: 124, text: "A cricket field is circular with radius 70 m. The boundary rope covers only a sector of 120° for practice nets. Find the area and length of the rope needed.", choices: ["146.6m", "150.3m", "160m", "180.5m"], correctIndex: 0, runs: 4, stage: "finals" },
  { id: 125, text: "A bowler concedes 5, 3, 2, 4, 6, 0 runs in 6 balls. Find the mean and variance of runs per ball.", choices: ["3.33, 3.22", "3.33, 3.56", "3.33, 3.89", "3.33, 2.56"], correctIndex: 2, runs: 4, stage: "finals" },
  { id: 126, text: "A circular cricket ground has radius 60 m. If the boundary rope is moved 10 m inward, find the percentage reduction in area.", choices: ["28.3%", "30.6%", "26.6%", "27.3%"], correctIndex: 1, runs: 4, stage: "finals" },
  { id: 127, text: "In an IPL match, Kohli and Maxwell have a partnership of 150 runs. Kohli scores runs in the ratio of 3:2 compared to Maxwell. Later, Kohli hits a six off a no-ball, which adds 7 runs to his score. Find Kohli’s new percentage of total partnership.", choices: ["61%", "62%", "63%", "65%"], correctIndex: 1, runs: 6, stage: "finals" },
  { id: 128, text: "Given team R wants to gain 0.5 Net Run Rate after the match. Now team R and team A are matched for a T20 match and team A set a target of 150. Then find the number of overs in which the match has to be finished.", choices: ["18.70", "18.75", "18.85", "None"], correctIndex: 1, runs: 6, stage: "finals" },
  { id: 129, text: "Before his last match, Suresh's average score was 54. In his last match, he scored 60 runs which increased his average to 55. What runs must he score in his next match to increase his average to 56?", choices: ["56", "62", "70", "68"], correctIndex: 1, runs: 6, stage: "finals" },
  { id: 130, text: "A player's average after 12 innings is 48. He scores 72 in the 13th innings. What is his new average?", choices: ["50", "49", "51", "52"], correctIndex: 0, runs: 6, stage: "finals" },
