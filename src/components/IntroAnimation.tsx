    ...
    <AnimatePresence>
      {show && (
        ...
        >
          ...
          {/* Collaboration Logos with Text */}
          <motion.div
            className="flex items-end gap-12 mt-8"
          ...
          >
            ...
            <div className="flex flex-col items-center">
              ...
              />
              <p className="mt-2 text-gray-300 text-sm font-semibold tracking-wider">
                RMC
              </p>
            </div>
